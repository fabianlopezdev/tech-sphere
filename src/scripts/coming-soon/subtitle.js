document.addEventListener('DOMContentLoaded', () => {
    ...
    // --- Config ---
    const words = ['DESIGN', 'DEVELOPMENT', 'GROWTH', "MARKETING", "APPS","LEADS", "WEBSITES", "SOFTWARE", "AI"]; 
    ...
    function animateLetter(span, targetChar) { /* ... unchanged ... */ 
    ...
    function displayWord(word) { /* ... unchanged ... */ 
